...
int main(int argc, char* argv[])
{
  ...
  float avg_runtime = total_runtime / runs;
  printf("avg runtime: %.6f s\n", avg_runtime);
  printf("avg throughput: %.6f Mnodes/s\n", g.nodes * 0.000001 / avg_runtime);
  printf("avg throughput: %.6f Medges/s\n", g.edges * 0.000001 / avg_runtime);
